...
namespace PrjCidadeInteligente
{
    public partial class Funcionario : Form
    {
         ...
         private void CadastrarCliente(string DS_Cargo, string DS_Salario, string Ramal)
        {
            //conexão com banco
            SqlConnection conexao = new SqlConnection();
            conexao.ConnectionString = "Password=info211;Persist Security Info=False;User ID=sa;Initial Catalog=SGCidadeInteligente;Data Source=LAB-07-17";
        ...
        private void carregarFuncionarios()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_retornarfuncionarios", conexao);
                ...
                DGVFuncionario.DataSource = ds.Tables[0];
